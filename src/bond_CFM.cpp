...
BondCFM::BondCFM(LAMMPS *lmp) : Bond(lmp)
{
...
void BondCFM::compute(int eflag, int vflag)
{
...
void BondCFM::coeff(int narg, char **arg)
{
...
double BondCFM::equilibrium_distance(int i)
{
  return 0.97;
}
...
void BondCFM::write_restart(FILE *fp)
{
...
void BondCFM::read_restart(FILE *fp)
{
  allocate();
...
void BondCFM::write_data(FILE *fp)
{
...
double BondCFM::single(int type, double rsq, int i, int j,
                           double &fforce)
{
